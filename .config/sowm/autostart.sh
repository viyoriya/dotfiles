...
while true; do
    ...
    sleep 3s
done | lemonbar -d -g x18xx -u 3 -n "sowm" -B "#FF1F222D" -f "monospace:size=9" -f "Font Awesome 5 Brands Regular:style=Regular:size=9" -f "Font Awesome 5 Free Solid:style=Solid:size=9" &
